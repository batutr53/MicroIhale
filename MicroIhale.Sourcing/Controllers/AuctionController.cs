...
namespace MicroIhale.Sourcing.Controllers
{
    ...
    public class AuctionController : ControllerBase
    {
        ...
        private readonly EventBusRabbitMQProcuder _eventBus;

        public AuctionController(IAuctionRepository auctionRepository, ILogger<AuctionController> logger, IBidRepository bidRepository, IMapper mapper, EventBusRabbitMQProcuder eventBus)
        {
        ...
        public async Task<ActionResult<Auction>> GetAuction(string id)
        {
            ...
            if (auction == null)
            {
                _logger.LogError($"Auction with id: {id}, hsan't been found in database");
                return NotFound();
            }
            return Ok(auction);
        }
        ...
        public async Task<ActionResult<Auction>> CreatAction([FromBody]Auction auction)
        {
        ...
        [HttpPut]
        [ProducesResponseType(typeof(Auction), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<Auction>> UpdateAction([FromBody]Auction auction)
        {
        ...
        [ProducesResponseType(typeof(Auction), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<Auction>> DeleteActionId(string id)
        {
        ...
        public ActionResult<OrderCreateEvent> TestRabbit()
        {
